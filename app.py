...
# --- Route App Environment to Local Linuxbrew Binaries ---
brew_bin_path = "/mount/src/geoamr_app/.linuxbrew/bin"
if os.path.exists(brew_bin_path):
    if brew_bin_path not in os.environ["PATH"]:
